...
# Script to SSH into Azure VM and view live Oversight logs

echo "Setting up SSH connection to view live Oversight logs..."
...
echo "Connected to Azure Dev VM - viewing Oversight logs..."
